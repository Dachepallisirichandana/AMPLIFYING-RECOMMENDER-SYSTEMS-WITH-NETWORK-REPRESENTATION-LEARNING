    ...
    <body>
        ...
        <div id="abstract">
            <% String username=(String)session.getAttribute("username");%>
             ...
             <center><h2>Search Product Here</h2></center>
             <form name="search" action="SearchPostAction.jsp" method="post">
                 <table width="300px" height="100px">
                     <tr>
                            <td>Enter Product Name</td><td><input type="text" name="pname" required=""></td>
                     </tr>
